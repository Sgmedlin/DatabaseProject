        ...
        <form id="done" name="done" method="POST">
                  ...
                  <div class="form-group">
                    ...
                    <div id="table_ready" class="form-group table-responsive">
                        ...
                        <div align="right">
                            <button type="button" name="add" id="add" class="btn btn-success btn-xs" style="background-color:#aed581; border:none; color:black;">+</button>
                        </div>
                    </div>
                ...
                <label class="form-check-label" for="check">Make Group Private (invite only)</label>
                  ...
                  <div class="form-group">
                      <button type="submit" style="background-color:#aed581; border:none; color:black;" id="save" name="save" class="btn btn-primary">Submit</button>
...
<script>
    $('#done').ready(function(){
        ...
        $('#add').click(function(){
            ...
            html_code += "<td><button type='button' name='remove' data-row='row"+count+"' class='btn btn-danger btn-xs remove' style='background-color:#f54940; border:none; color:black;'>-</button></td>";
            html_code += "</tr>";
